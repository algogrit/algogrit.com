...
export const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: 'Elm', src: raw('elm'), invert: true },
      { name: 'Bash', src: raw('bash') },
  ...
  },
  {
    ...
    skills: [
      { name: 'Rails', src: gram('rails-original-wordmark') },
      ...
      { name: 'Tauri', src: raw('tauri') },
      { name: 'Node.js', src: raw('node-js') },
      { name: 'Tailwind CSS', src: raw('tailwindcss') },
      { name: 'D3.js', src: raw('d3') },
      ...
      { name: 'Less', src: gram('less-plain-wordmark'), invert: true },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Ubuntu', src: raw('ubuntu'), invert: true },
